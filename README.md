...
Tokens are snippets of cryptic text that are issued by the server and stored client-side. Tokens are used to confirm authentication prior to transferring data.

- [ ] What steps can you take in your web apps to keep your data secure?

We can use tokens to restrict access to private/protected routes.

- [ ] Describe how web servers work.

"Web servers" are computers that store the actual code for a website or programs that run on these computers. The computer is connected to the internet, and the program "serves" web pages by retrieving data for users upon request.
